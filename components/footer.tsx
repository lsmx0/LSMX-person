    ...
    <footer className="border-t border-sketch-stroke/10 py-8 mt-16">
      <div className="max-w-5xl mx-auto px-4 flex flex-col tablet:flex-row items-center justify-between gap-4 text-sm text-[var(--muted)]">
        ...
        <div className="flex items-center gap-4">
          <a href="mailto:lsmx_0@163.com" aria-label="Email" className="hover:text-foreground transition-colors" title="lsmx_0@163.com">
            <Mail className="w-5 h-5" />
          </a>
          <span className="hover:text-foreground transition-colors cursor-default" title="QQ: 1286962598">
            <MessageCircle className="w-5 h-5" />
          </span>
          <span className="hover:text-foreground transition-colors cursor-default" title="WeChat: LSMX_1">
